...
from google.cloud.bigquery.datapolicies_v1.services.data_policy_service import DataPolicyServiceAsyncClient
from google.cloud.bigquery.datapolicies_v1.services.data_policy_service import DataPolicyServiceClient
from google.cloud.bigquery.datapolicies_v1.services.data_policy_service import pagers
from google.cloud.bigquery.datapolicies_v1.services.data_policy_service import transports
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery.datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__') as grpc_transport:
...
def test_rename_data_policy(request_type, transport: str = 'grpc'):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rename_data_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datapolicy.DataPolicy(
            name='name_value',
...
def test_rename_data_policy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.rename_data_policy),
            '__call__') as call:
        client.rename_data_policy()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == datapolicy.RenameDataPolicyRequest()

@pytest.mark.asyncio
async def test_rename_data_policy_async(transport: str = 'grpc_asyncio', request_type=datapolicy.RenameDataPolicyRequest):
    client = DataPolicyServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.rename_data_policy(request)
...
@pytest.mark.asyncio
async def test_rename_data_policy_async_from_dict():
    await test_rename_data_policy_async(request_type=dict)


def test_rename_data_policy_field_headers():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = datapolicy.DataPolicy()
        client.rename_data_policy(request)
...
@pytest.mark.asyncio
async def test_rename_data_policy_field_headers_async():
    client = DataPolicyServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datapolicy.DataPolicy())
        await client.rename_data_policy(request)
...
def test_rename_data_policy_flattened():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = 'name_value'
        assert arg == mock_val
        arg = args[0].new_data_policy_id
        mock_val = 'new_data_policy_id_value'
        assert arg == mock_val


def test_rename_data_policy_flattened_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_rename_data_policy_flattened_async():
    client = DataPolicyServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.rename_data_policy(
            name='name_value',
            new_data_policy_id='new_data_policy_id_value',
        )
...
@pytest.mark.asyncio
async def test_rename_data_policy_flattened_error_async():
    client = DataPolicyServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.rename_data_policy(
            datapolicy.RenameDataPolicyRequest(),
            name='name_value',
            new_data_policy_id='new_data_policy_id_value',
        )
...
def test_create_data_policy_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    request_init["data_policy"] = {'policy_tag': 'policy_tag_value', 'data_masking_policy': {'predefined_expression': 3}, 'name': 'name_value', 'data_policy_type': 3, 'data_policy_id': 'data_policy_id_value'}
...
def test_create_data_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = datapolicy.DataPolicy.to_json(datapolicy.DataPolicy())
...
def test_create_data_policy_rest_bad_request(transport: str = 'rest', request_type=datapolicy.CreateDataPolicyRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/dataPolicies" % client.transport._host, args[1])
...
def test_create_data_policy_rest_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_update_data_policy_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    request_init["data_policy"] = {'policy_tag': 'policy_tag_value', 'data_masking_policy': {'predefined_expression': 3}, 'name': 'projects/sample1/locations/sample2/dataPolicies/sample3', 'data_policy_type': 3, 'data_policy_id': 'data_policy_id_value'}
    request = request_type(**request_init)
...
def test_update_data_policy_rest_bad_request(transport: str = 'rest', request_type=datapolicy.UpdateDataPolicyRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{data_policy.name=projects/*/locations/*/dataPolicies/*}" % client.transport._host, args[1])
...
def test_update_data_policy_rest_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_rename_data_policy_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_rename_data_policy_rest_required_fields(request_type=datapolicy.RenameDataPolicyRequest):
    transport_class = transports.DataPolicyServiceRestTransport

    request_init = {}
    request_init["name"] = ""
    request_init["new_data_policy_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).rename_data_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["name"] = 'name_value'
    jsonified_request["newDataPolicyId"] = 'new_data_policy_id_value'
    ...
    assert "newDataPolicyId" in jsonified_request
    assert jsonified_request["newDataPolicyId"] == 'new_data_policy_id_value'
...
def test_rename_data_policy_rest_unset_required_fields():
    transport = transports.DataPolicyServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.rename_data_policy._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "newDataPolicyId", )))


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_rename_data_policy_rest_interceptors(null_interceptor):
    transport = transports.DataPolicyServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataPolicyServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_rename_data_policy") as post, \
         mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_rename_data_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datapolicy.RenameDataPolicyRequest.pb(datapolicy.RenameDataPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.rename_data_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_rename_data_policy_rest_bad_request(transport: str = 'rest', request_type=datapolicy.RenameDataPolicyRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rename_data_policy_rest_flattened():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.rename_data_policy(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataPolicies/*}:rename" % client.transport._host, args[1])


def test_rename_data_policy_rest_flattened_error(transport: str = 'rest'):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rename_data_policy_rest_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_data_policy_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_data_policy_rest_bad_request(transport: str = 'rest', request_type=datapolicy.DeleteDataPolicyRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataPolicies/*}" % client.transport._host, args[1])
...
def test_delete_data_policy_rest_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_get_data_policy_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_data_policy_rest_bad_request(transport: str = 'rest', request_type=datapolicy.GetDataPolicyRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_data_policy_rest_error():
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_data_policies_rest(request_type):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = datapolicy.ListDataPoliciesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_data_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = datapolicy.ListDataPoliciesResponse.to_json(datapolicy.ListDataPoliciesResponse())
...
def test_list_data_policies_rest_bad_request(transport: str = 'rest', request_type=datapolicy.ListDataPoliciesRequest):
    client = DataPolicyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceTransport.__init__') as Transport:
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_policy_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataPolicyServiceTransport()
        adc.assert_called_once()
...
def test_data_policy_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.rename_data_policy._session
    session2 = client2.transport.rename_data_policy._session
    assert session1 != session2
